...
import { ShoppingCartOutlined, Visibility, VisibilityOutlined } from '@mui/icons-material';
...
const PrimeDeals = () => {
    return (
        <div style={{ padding: '30px 20px', backgroundColor: '#f5f2e8', fontFamily: 'Arial, sans-serif' }}>
            ...
            <div  className='primeContainer' style={{ width: '100%', display: 'flex', justifyContent:'space-between'}}>
                <div className='primeFirstItem' >
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <p className='prime-first-description' style={{ fontSize: '14px', color: '#666', marginBottom: '10px' }}>C to C Type Cable 60W Fast Charging 5A Fast Charging Premium Build Quality Versatile Usage Universal Compatibility Supports all Type C Devices like Smartphone, Macbook, Laptop and etc.</p>
                            ...
                            <div className='primeProductItem1-actions' style={{  gap: '10px' }}>
                                <button style={{
                            ...
                            <div className='primeProductItem1-small-actions' style={{  gap: '10px' }}>
                                <button style={{
                                    backgroundColor: 'black',
                                    color: 'white',
                                    padding: '8px 12px',
                ...
                <div className='primeItemContainer' style={{ display: 'flex', justifyContent:'space-around', flexWrap: 'wrap' }}>
                    {products.map((product, index) => (
                        ...
                        style={{
                            ...
                            <div className='primeProductItem-img-container'>
                                ...
                                <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}><Visibility style={{color:'white'}}/></div>
                            </div>
                            ...
                            <div className="primeProductItem-actions" style={{  gap: '5px' }}>
                                <button style={{
                                    backgroundColor: 'black',
                                    color: 'white',
                                    padding: '5px',
                            ...
                            <div className='primeProductItem-small-actions' style={{  gap: '5px' }}>
                                <button style={{
                                    backgroundColor: 'black',
                                    color: 'white',
                                    padding: '5px',
